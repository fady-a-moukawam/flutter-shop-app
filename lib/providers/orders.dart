...
// here we are passing the token and userId through the constructor
  ...
  Future<void> fetchAndSetOrders() async {
    final url = Uri.parse(
        'https://flutter-shop-app-1f18f-default-rtdb.firebaseio.com/orders/$userId.json?auth=$authToken');
